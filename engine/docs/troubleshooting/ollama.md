...
When using Ollama as a provider with anyon agents, you may encounter:

```
JSON Parse error: Unexpected EOF
```

This occurs when agents attempt tool calls (e.g., `scout` agent using `mcp_grep_search`).
...
- **anyon**: Passes through the SDK's behavior (can't fix at this layer)
...
- **Problematic**: Any agent with tool calls (scout, researcher, etc.)
...
**Tracking**: https://github.com/SL-IT-AMAZING/anyon-cli/issues/1124
...
- **anyon**: https://github.com/SL-IT-AMAZING/anyon-cli/issues/1124
