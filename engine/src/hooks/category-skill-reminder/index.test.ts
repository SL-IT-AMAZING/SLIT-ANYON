...
describe("category-skill-reminder hook", () => {
  ...
  describe("target agent detection", () => {
    test("should inject reminder for conductor agent after 3 tool calls", async () => {
      // given - conductor agent session with multiple tool calls
    ...
    test("should inject reminder for taskmaster agent", async () => {
      // given - taskmaster agent session
      const hook = createHook();
      const sessionID = "taskmaster-session";
      updateSessionAgent(sessionID, "Taskmaster");
    ...
    test("should inject reminder for worker agent", async () => {
      // given - worker agent session
      const hook = createHook();
      const sessionID = "junior-session";
      updateSessionAgent(sessionID, "worker");
    ...
    test("should NOT inject reminder for non-target agents", async () => {
      // given - researcher agent session (not a target)
      const hook = createHook();
      const sessionID = "researcher-session";
      updateSessionAgent(sessionID, "researcher");
    ...
    test("should detect agent from input.agent when session state is empty", async () => {
      ...
      await hook["tool.execute.after"](
        { tool: "edit", sessionID, callID: "1", agent: "Conductor" },
        output,
      );
      await hook["tool.execute.after"](
        { tool: "edit", sessionID, callID: "2", agent: "Conductor" },
        output,
      );
      await hook["tool.execute.after"](
        { tool: "edit", sessionID, callID: "3", agent: "Conductor" },
        output,
      );
  ...
  describe("delegation tool tracking", () => {
    test("should NOT inject reminder if task is used", async () => {
      // given - conductor agent that uses task
      const hook = createHook();
    ...
    test("should NOT inject reminder if call_anyon_agent is used", async () => {
      // given - conductor agent that uses call_anyon_agent
      const hook = createHook();
      ...
      // when - call_anyon_agent is used first
      await hook["tool.execute.after"](
        { tool: "call_anyon_agent", sessionID, callID: "1" },
        output,
      );
      await hook["tool.execute.after"](
        { tool: "edit", sessionID, callID: "2" },
    ...
    test("should NOT inject reminder if task tool is used", async () => {
      // given - conductor agent that uses task tool
      const hook = createHook();
  ...
  describe("tool call counting", () => {
    test("should NOT inject reminder before 3 tool calls", async () => {
      // given - conductor agent with only 2 tool calls
      const hook = createHook();
    ...
    test("should only count delegatable work tools", async () => {
      // given - conductor agent with mixed tool calls
      const hook = createHook();
  ...
  describe("event handling", () => {
    test("should reset state on session.deleted event", async () => {
      // given - conductor agent with reminder already shown
      const hook = createHook();
  ...
  describe("case insensitivity", () => {
    test("should handle tool names case-insensitively", async () => {
      // given - conductor agent with mixed case tool names
      const hook = createHook();
    ...
    test("should handle delegation tool names case-insensitively", async () => {
      // given - conductor agent using TASK in uppercase
      const hook = createHook();
