 ...
 */
const TARGET_AGENTS = new Set(["conductor", "worker", "taskmaster"]);
 ...
 */
const DELEGATION_TOOLS = new Set(["task", "call_anyon_agent"]);
...
export function createCategorySkillReminderHook(
  ...
  function isTargetAgent(sessionID: string, inputAgent?: string): boolean {
    ...
    return (
      ...
      agentKey.includes("conductor") ||
      agentKey.includes("taskmaster")
    );
  }
