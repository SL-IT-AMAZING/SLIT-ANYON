...
├── no-hephaestus-non-gpt/      # Block Craftsman from non-GPT
├── no-sisyphus-gpt/            # Block Conductor from GPT
...
├── sisyphus-junior-notepad/    # Worker notepad
├── start-work/                 # Conductor work session starter
...
| noSisyphusGpt | chat.message | Block Conductor from using GPT models (toast warning) |
| noHephaestusNonGpt | chat.message | Block Craftsman from using non-GPT models |
