...
export function readState(
  ...
  try {
    ...
    return {
      ...
      turbo: data.turbo === true || data.turbo === "true" ? true : undefined,
      strategy:
...
export function writeState(
  ...
  try {
    ...
    const sessionIdLine = state.session_id
      ...
      : "";
    const turboLine =
      state.turbo !== undefined ? `turbo: ${state.turbo}\n` : "";
...
${sessionIdLine}${turboLine}${strategyLine}${messageCountAtStartLine}---
${state.prompt}
`;
