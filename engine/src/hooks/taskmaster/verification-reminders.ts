...
**THESIS STATE:** Plan: \`${planName}\` | ${progress.completed}/${progress.total} done | ${remaining} remaining
...
\`\`\`
Glob(".anyon/notepads/${planName}/*.md")
\`\`\`
...
**STEP 6: CHECK THESIS STATE DIRECTLY (EVERY TIME — NO EXCEPTIONS)**

Do NOT rely on cached progress. Read the plan file NOW:
\`\`\`
Read(".anyon/plans/${planName}.md")
\`\`\`
...
Update the plan file \`.anyon/plans/${planName}.md\`:
...
**${remaining} tasks remain. Keep thesising.**`
}
