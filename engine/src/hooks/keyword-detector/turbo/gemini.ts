/**
 * Gemini-optimized turbo message.
 *
...
export const TURBO_GEMINI_MESSAGE = `<turbo-mode>
...
2. Spawn exploration/researcher agents via task(run_in_background=true) in PARALLEL
...
export function getGeminiTurboMessage(): string {
  return TURBO_GEMINI_MESSAGE;
}
