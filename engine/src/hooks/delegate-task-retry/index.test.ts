...
describe("conductor-task-retry", () => {
  ...
  describe("detectDelegateTaskError", () => {
    ...
    it("should detect unknown agent error", () => {
      const output =
        '[ERROR] Unknown agent: "fake-agent". Available agents: scout, researcher, advisor';
  ...
  describe("buildRetryGuidance", () => {
    ...
    it("should provide fix for unknown agent with available list", () => {
      const errorInfo = {
        ...
        originalOutput:
          '[ERROR] Unknown agent: "fake". Available agents: scout, advisor',
      };
