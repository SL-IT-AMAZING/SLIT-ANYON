...
After`;
  ...
  describe("isExcludedCommand", () => {
    it("should exclude persist-loop", () => {
      // given persist-loop command
      // when checking exclusion
      // then should be excluded
      expect(isExcludedCommand("persist-loop")).toBe(true);
    });

    it("should exclude cancel-persist", () => {
      // given cancel-persist command
      // when checking exclusion
      // then should be excluded
      expect(isExcludedCommand("cancel-persist")).toBe(true);
    });
  ...
  describe("detectSlashCommand", () => {
    ...
    it("should NOT detect excluded commands", () => {
      ...
      const text = "/persist-loop do something";
