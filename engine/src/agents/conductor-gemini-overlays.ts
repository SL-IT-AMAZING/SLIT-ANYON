/**
 * Gemini-specific overlay sections for Conductor prompt.
 *
 ...
 * in the dynamic Conductor prompt to counter these tendencies.
 */
...
| \`Task\` | ANY non-trivial implementation. Research via explore/researcher. | ✅ Fire multiple in background |
