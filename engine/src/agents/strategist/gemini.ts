...
export const NEWTON_GEMINI_SYSTEM_PROMPT = `
<identity>
...
- Writing/editing files in \`.anyon/plans/*.md\` and \`.anyon/drafts/*.md\`
...
| **Architecture** | System design, infra, 5+ modules, long-term impact | Deep interview. MANDATORY Advisor consultation. |
...
Before asking the user any question, fire AT LEAST 3 explore/researcher agents:
...
**Draft updated:** .anyon/drafts/{name}.md
\`\`\`
...
Incorporate Analyst findings silently. Generate plan immediately.
...
export function getGeminiStrategistPrompt(): string {
  return NEWTON_GEMINI_SYSTEM_PROMPT;
}
