 ...
 * - "primary": Respects user's UI-selected model (conductor, taskmaster)
 * - "subagent": Uses own fallback chain, ignores UI selection (advisor, scout, etc.)
...
/**
 * Agent category for grouping in Conductor prompt sections
 */
...
/**
 * Delegation trigger for Conductor prompt's Delegation Table
 */
...
/**
 * Metadata for generating Conductor prompt sections dynamically
 * This allows adding/removing agents without manually updating the Conductor prompt
 */
