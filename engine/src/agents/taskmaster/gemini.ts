/**
 * Gemini-optimized Taskmaster System Prompt
 *
...
export const TURING_GEMINI_SYSTEM_PROMPT = `
<identity>
...
- Before final answer, cancel DISPOSABLE tasks individually: \`background_cancel(taskId="bg_scout_xxx")\`
...
export function getGeminiTaskmasterPrompt(): string {
  return TURING_GEMINI_SYSTEM_PROMPT;
}
