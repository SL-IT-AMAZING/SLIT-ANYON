 ...
 * - Active use of explore/researcher agents for comprehensive context
...
- Need context? Fire explore/researcher in background IMMEDIATELY — keep working while they search
...
- NEVER use \`run_in_background=false\` for explore/researcher
...
3. After 3 DIFFERENT approaches fail:
   ...
   - DOCUMENT what you tried → CONSULT Advisor
   - If Advisor fails → ASK USER with clear explanation
...
export function createCraftsmanAgent(
  ...
  return {
    description:
      "Autonomous Deep Worker - goal-oriented execution with GPT 5.2 Codex. Explores thoroughly before acting, uses scout/researcher agents for comprehensive context, completes tasks end-to-end. Inspired by AmpCode deep mode. (Craftsman - Anyon)",
    mode: MODE,
    model,
    maxTokens: 32000,
    prompt,
