...
describe("loadJsonFile", () => {
  ...
  it("discovers JSONC-only user config (anyon.jsonc)", () => {
  ...
  "lsp": {
    "user-jsonc": {
      ...
      const userPath = join(tempBase, "anyon.jsonc");
  ...
  it("discovers JSONC-only project config (.opencode/anyon.jsonc)", () => {
  ...
  "lsp": {
    "project-jsonc": {
      ...
      const projectPath = join(tempProject, ".opencode", "anyon.jsonc");
  ...
  "lsp": {
    "conflict": {
      ...
      writeFileSync(join(tempBase, "anyon.json"), jsonContent, "utf-8");
      writeFileSync(join(tempBase, "anyon.jsonc"), jsoncContent, "utf-8");
