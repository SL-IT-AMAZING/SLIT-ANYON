...
export async function executeSync(
  ...
  log(`[call_anyon_agent] Sending prompt to session ${sessionID}`);
  log(`[call_anyon_agent] Prompt text:`, args.prompt.substring(0, 100));
  ...
  try {
    ...
    log(`[call_anyon_agent] Prompt error:`, errorMessage);
    if (
