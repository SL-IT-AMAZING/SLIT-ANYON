/**
 * Unified system directive prefix for anyon internal messages.
 ...
 * @param type - The directive type (e.g., "TODO CONTINUATION", "PERSIST LOOP")
...
/**
 * Checks if a message starts with the anyon system directive prefix.
...
export const SystemDirectiveTypes = {
  ...
  PERSIST_LOOP: "PERSIST LOOP",
  THESIS_CONTINUATION: "THESIS CONTINUATION",
