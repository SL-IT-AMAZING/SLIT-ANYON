...
export function migrateConfigFile(
  ...
  if (copy.omo_agent !== undefined) {
    copy.conductor_agent = copy.omo_agent;
    delete copy.omo_agent;
    needsWrite = true;
  }

  if (copy.euler_agent !== undefined) {
    copy.conductor_agent = copy.euler_agent;
    delete copy.euler_agent;
    needsWrite = true;
  }
