> [!NOTE]
>
> [![Euler Labs - Euler is the agent that codes like your team.](./.github/assets/eulerlabs.png?v=2)](https://eulerlabs.ai)
> > **We're building a fully productized version of Euler to define the future of frontier agents. <br />Join the waitlist [here](https://eulerlabs.ai).**

> [!TIP]
> Be with us!
>
> | [<img alt="Discord link" src="https://img.shields.io/discord/1452487457085063218?color=5865F2&label=discord&labelColor=black&logo=discord&logoColor=white&style=flat-square" width="156px" />](https://discord.gg/PUwSMR9XNk) | Join our [Discord community](https://discord.gg/PUwSMR9XNk) to connect with contributors and fellow `anyon` users. |
> | :-----| :----- |
> | [<img alt="X link" src="https://img.shields.io/badge/Follow-%40justeuler-00CED1?style=flat-square&logo=x&labelColor=black" width="156px" />](https://x.com/justeuler) | News and updates for `anyon` used to be posted on my X account. <br /> Since it was suspended mistakenly, [@justeuler](https://x.com/justeuler) now posts updates on my behalf. |
...
[![Anyon](./.github/assets/hero.jpg)](https://github.com/SL-IT-AMAZING/anyon-cli#anyon)

[![Preview](./.github/assets/anyon.png)](https://github.com/SL-IT-AMAZING/anyon-cli#anyon)
...
[![GitHub Release](https://img.shields.io/github/v/release/SL-IT-AMAZING/anyon-cli?color=369eff&labelColor=black&logo=github&style=flat-square)](https://github.com/SL-IT-AMAZING/anyon-cli/releases)
[![npm downloads](https://img.shields.io/npm/dt/@anyon-cli/anyon?color=ff6b35&labelColor=black&style=flat-square)](https://www.npmjs.com/package/@anyon-cli/anyon)
[![GitHub Contributors](https://img.shields.io/github/contributors/SL-IT-AMAZING/anyon-cli?color=c4f042&labelColor=black&style=flat-square)](https://github.com/SL-IT-AMAZING/anyon-cli/graphs/contributors)
[![GitHub Forks](https://img.shields.io/github/forks/SL-IT-AMAZING/anyon-cli?color=8ae8ff&labelColor=black&style=flat-square)](https://github.com/SL-IT-AMAZING/anyon-cli/network/members)
[![GitHub Stars](https://img.shields.io/github/stars/SL-IT-AMAZING/anyon-cli?color=ffcb47&labelColor=black&style=flat-square)](https://github.com/SL-IT-AMAZING/anyon-cli/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/SL-IT-AMAZING/anyon-cli?color=ff80eb&labelColor=black&style=flat-square)](https://github.com/SL-IT-AMAZING/anyon-cli/issues)
[![License](https://img.shields.io/badge/license-SUL--1.0-white?labelColor=black&style=flat-square)](https://github.com/SL-IT-AMAZING/anyon-cli/blob/dev/LICENSE.md)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/SL-IT-AMAZING/anyon-cli)
...
> "If Claude Code does in 7 days what a human does in 3 months, Euler does it in 1 hour. It just works until the task is done. It is a discipline agent." <br/>- B, Quant Researcher

> "Knocked out 8000 eslint warnings with Anyon, just in a day" <br/>- [Jacob Ferrari](https://x.com/jacobferrari_/status/2003258761952289061)

> "I converted a 45k line tauri app into a SaaS web app overnight using Anyon and persist loop. Started with interview me prompt, asked it for ratings and recommendations on the questions. It was amazing to watch it work and to wake up this morning to a mostly working website!" - [James Hargis](https://x.com/hargabyte/status/2007299688261882202)

> "use anyon, you will never go back" <br/>- [d0t3ch](https://x.com/d0t3ch/status/2001685618200580503)

> "I haven't really been able to articulate exactly what makes it so great yet, but the development experience has reached a completely different dimension." - [
苔硯:こけすずり](https://x.com/kokesuzuri/status/2008532913961529372?s=20)

> "Experimenting with open code, anyon and supermemory this weekend to build some minecraft/souls-like abomination."
...
> "Anyon Is Actually Insane" - [YouTube - Darren Builds AI](https://www.youtube.com/watch?v=G_Snfh2M41M)
...
```
Install and configure anyon by following the instructions here:
https://raw.githubusercontent.com/SL-IT-AMAZING/anyon-cli/refs/heads/dev/docs/guide/installation.md
```
...
```bash
curl -s https://raw.githubusercontent.com/SL-IT-AMAZING/anyon-cli/refs/heads/dev/docs/guide/installation.md
```
...
```
Read this and tell me why it's not just another boilerplate: https://raw.githubusercontent.com/SL-IT-AMAZING/anyon-cli/refs/heads/dev/README.md
```
...
Install. Type `turbo` (or `ulw`). Done.

Everything below, every feature, every optimization, you don't need to know it. It just works.

Even only with following subscriptions, turbo will work well (this project is not affiliated, this is just personal recommendation):
...
| :---: | :------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   🤖   | **Discipline Agents**                                    | Euler orchestrates Tesla, Socrates, Curie, Explore. A full AI dev team in parallel.                                                                                                                    |
|   ⚡   | **`turbo` / `ulw`**                                  | One word. Every agent activates. Doesn't stop until done.                                                                                                                                                        |
...
|   🔁   | **Persist Loop / `/anyon-loop`**                             | Self-referential loop. Doesn't stop until 100% done.                                                                                                                                                             |
...
|   📋   | **Newton Planner**                                   | Interview-mode strategic planning before any execution.                                                                                                                                                          |
...
<table><tr>
<td align="center"><img src=".github/assets/euler.png" height="300" /></td>
<td align="center"><img src=".github/assets/tesla.png" height="300" /></td>
</tr></table>

**Euler** (`claude-opus-4-6` / **`kimi-k2.5`** / **`glm-5`** ) is your main orchestrator. He plans, delegates to specialists, and drives tasks to completion with aggressive parallel execution. He does not stop halfway.

**Tesla** (`gpt-5.3-codex`) is your autonomous deep worker. Give him a goal, not a recipe. He explores the codebase, researches patterns, and executes end-to-end without hand-holding. *The Legitimate Craftsman.*

**Newton** (`claude-opus-4-6` / **`kimi-k2.5`** / **`glm-5`** ) is your strategic planner. Interview mode: it questions, identifies scope, and builds a detailed plan before a single line of code is touched.

Every agent is tuned to its model's specific strengths. No manual model-juggling. [Learn more →](docs/guide/overview.md)

> Anthropic [blocked OpenCode because of us.](https://x.com/thdxr/status/2010149530486911014) That's why Tesla is called "The Legitimate Craftsman." The irony is intentional.
>
> We run best on Opus, but Kimi K2.5 + GPT-5.3 Codex already beats vanilla Claude Code. Zero config needed.

### Agent Orchestration

When Euler delegates to a subagent, it doesn't pick a model. It picks a **category**. The category maps automatically to the right model:
...
`/start-work` calls Newton. **Interviews you like a real engineer**, identifies scope and ambiguities, builds a verified plan before touching code. Agent knows what it's building before it starts.
...
> **New to anyon?** Read the **[Overview](docs/guide/overview.md)** to understand what you have, or check the **[Orchestration Guide](docs/guide/orchestration.md)** for how agents collaborate.
...
1. **Remove the plugin from your OpenCode config**
   ...
   Edit `~/.config/opencode/opencode.json` (or `opencode.jsonc`) and remove `"@anyon-cli/anyon"` from the `plugin` array:

   ```bash
   # Using jq
   jq '.plugin = [.plugin[] | select(. != "@anyon-cli/anyon")]' \
...
2. **Remove configuration files (optional)**
   ...
   ```bash
   # Remove user config
   rm -f ~/.config/opencode/anyon.json ~/.config/opencode/anyon.jsonc

   # Remove project config (if exists)
   rm -f .opencode/anyon.json .opencode/anyon.jsonc
   ```
...
**Quick Overview:**
- **Agents**: Euler (the main agent), Newton (planner), Socrates (architecture/debugging), Curie (docs/code search), Explore (fast codebase grep), Multimodal Looker
...
- **Productivity Features**: Persist Loop, Todo Enforcer, Comment Checker, Think Mode, and more
...
**Quick Overview:**
- **Config Locations**: `.opencode/anyon.jsonc` or `.opencode/anyon.json` (project), `~/.config/opencode/anyon.jsonc` or `~/.config/opencode/anyon.json` (user)
- **JSONC Support**: Comments and trailing commas supported
- **Agents**: Override models, temperatures, prompts, and permissions for any agent
- **Built-in Skills**: `playwright` (browser automation), `git-master` (atomic commits)
- **Euler Agent**: Main orchestrator with Newton (Planner) and Lovelace (Plan Consultant)
...
**Want the philosophy?** Read the [Turbo Manifesto](docs/manifesto.md).
...
If OpenCode is Debian/Arch, Anyon is Ubuntu/[Omarchy](https://omarchy.org/).
