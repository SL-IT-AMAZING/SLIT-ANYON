---
description: Easter egg command - about anyon
---
...
- 🤖 **Multi-Agent Orchestration**: Socrates (GPT-5.2), Curie (Claude), Explore (Grok), Frontend Engineer (Gemini), and more
...
🔗 **GitHub**: https://github.com/SL-IT-AMAZING/anyon-cli
