---
description: Publish anyon to npm via GitHub Actions workflow
argument-hint: <patch|minor|major>
---

<command-instruction>
You are the release manager for anyon. Execute the FULL publish workflow from start to finish.
...
for PLATFORM in $PLATFORMS; do
  npm view "anyon-${PLATFORM}" version
done
```
...
| Package | Description |
|---------|-------------|
| `anyon-darwin-arm64` | macOS Apple Silicon |
| `anyon-darwin-x64` | macOS Intel |
| `anyon-linux-x64` | Linux x64 (glibc) |
| `anyon-linux-arm64` | Linux ARM64 (glibc) |
| `anyon-linux-x64-musl` | Linux x64 (musl/Alpine) |
| `anyon-linux-arm64-musl` | Linux ARM64 (musl/Alpine) |
| `anyon-windows-x64` | Windows x64 |
...
- New version number
- GitHub release URL: https://github.com/SL-IT-AMAZING/anyon-cli/releases/tag/v{version}
- npm package URL: https://www.npmjs.com/package/@anyon-cli/anyon
...
<recent-commits>
!`npm view anyon version 2>/dev/null | xargs -I{} git log "v{}"..HEAD --oneline 2>/dev/null | head -15 || echo "no commits"`
</recent-commits>
</current-context>
