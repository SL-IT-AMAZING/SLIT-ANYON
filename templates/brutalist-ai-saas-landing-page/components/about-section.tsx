            ...
            <div className="flex flex-col gap-6">
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  ...
                  routing, sub-5ms inference, and transparent operational
                  control across every edge node in the network.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Founded by systems engineers who spent a decade building
                  distributed compute at hyperscale. We believe AI
                  infrastructure should be inspectable, auditable, and brutally
                  fast.
                </p>
              </motion.div>
