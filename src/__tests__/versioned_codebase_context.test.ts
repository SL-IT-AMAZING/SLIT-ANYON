...
describe("parseFilesFromMessage", () => {
  describe("anyon-read tags", () => {
    it("should parse a single anyon-read tag", () => {
      const input =
        '<anyon-read path="src/components/Button.tsx"></anyon-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    });

    it("should parse multiple anyon-read tags", () => {
      const input = `
        <anyon-read path="src/components/Button.tsx"></anyon-read>
        <anyon-read path="src/utils/helpers.ts"></anyon-read>
        <anyon-read path="src/styles/main.css"></anyon-read>
      `;
      const result = parseFilesFromMessage(input);
    ...
    it("should trim whitespace from file paths in anyon-read tags", () => {
      const input =
        '<anyon-read path="  src/components/Button.tsx  "></anyon-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    ...
    it("should handle file paths with special characters", () => {
      const input =
        '<anyon-read path="src/components/@special/Button-v2.tsx"></anyon-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/@special/Button-v2.tsx"]);
    });
  });

  describe("anyon-code-search-result tags", () => {
    it("should parse a single file from anyon-code-search-result", () => {
      const input = `<anyon-code-search-result>
src/components/Button.tsx
    ...
    it("should parse multiple files from anyon-code-search-result", () => {
      const input = `<anyon-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should skip empty lines in anyon-code-search-result", () => {
      const input = `<anyon-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should handle multiple anyon-code-search-result tags", () => {
      const input = `<anyon-code-search-result>
src/components/Button.tsx
src/components/Input.tsx
</anyon-code-search-result>
...
src/styles/main.css
  ...
  describe("mixed tags", () => {
    it("should parse both anyon-read and anyon-code-search-result tags", () => {
      const input = `
<anyon-read path="src/config/app.ts"></anyon-read>
...
<anyon-read path="src/components/Header.tsx"></anyon-read>
...
<anyon-read path="src/config/site.ts"></anyon-read>
...
`;
    ...
    it("should handle nested angle brackets in file paths", () => {
      const input =
        '<anyon-read path="src/components/Generic<T>.tsx"></anyon-read>';
      const result = parseFilesFromMessage(input);
...
SRC/COMPONENTS/BUTTON.TSX
    ...
    it("should handle very long file paths", () => {
      ...
      const input = `<anyon-read path="${longPath}"></anyon-read>`;
      const result = parseFilesFromMessage(input);
...
describe("processChatMessagesWithVersionedFiles", () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'I found this file: <anyon-read path="src/old.ts"></anyon-read>',
          providerOptions: {
            "anyon-engine": {
      ...
      const chatMessages: ModelMessage[] = [
        {
          ...
          content: [
            {
              type: "text",
              text: 'Here is the file: <anyon-read path="src/array.ts"></anyon-read>',
            },
            {
              type: "text",
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "user",
          content:
            'Check this: <anyon-read path="src/user-file.ts"></anyon-read>',
        },
      ];
      const appPath = "/test/app";
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'File here: <anyon-read path="src/no-commit.ts"></anyon-read>',
          // No providerOptions
        },
        {
          role: "assistant",
          content:
            'Another file: <anyon-read path="src/no-commit2.ts"></anyon-read>',
          providerOptions: {
            // anyon-engine not set
          },
        },
      ];
      const appPath = "/test/app";
  ...
  describe("parsing multiple file paths", () => {
    it("should process multiple files from anyon-code-search-result", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `<anyon-code-search-result>
src/file1.ts
src/file2.ts
</anyon-code-search-result>`,
          providerOptions: {
    ...
    it("should process mixed anyon-read and anyon-code-search-result tags", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `
<anyon-read path="src/file1.ts"></anyon-read>
  ...
  describe("error handling", () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'Missing file: <anyon-read path="src/missing.ts"></anyon-read>',
          providerOptions: {
            "anyon-engine": {
              sourceCommitHash: "commit1",
            },
    ...
    it("should handle getFileAtCommit throwing an error", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Error file: <anyon-read path="src/error.ts"></anyon-read>',
          providerOptions: {
            "anyon-engine": {
              sourceCommitHash: "commit1",
            },
  ...
  describe("multiple messages", () => {
    it("should process multiple messages with different commits", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        ...
        {
          role: "assistant",
          content: 'Here it is: <anyon-read path="src/file1.ts"></anyon-read>',
          providerOptions: {
            "anyon-engine": {
              sourceCommitHash: "commit1",
            },
        ...
        },
        {
          role: "assistant",
          content:
            'Here it is again: <anyon-read path="src/file1.ts"></anyon-read>',
          providerOptions: {
            "anyon-engine": {
  ...
  describe("integration with files parameter", () => {
    it("should combine files parameter with versioned files from messages", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Old version: <anyon-read path="src/old.ts"></anyon-read>',
          providerOptions: {
            "anyon-engine": {
              sourceCommitHash: "abc123",
            },
