...
export function anyonScriptsPlugin(
  options: AnyonScriptsPluginOptions = {},
): Plugin {
  const {
    workerDir = "worker",
    ...
    buildStart() {
      ...
      const loadScript = (filePath: string, description: string) => {
        try {
          ...
          console.warn(
            `⚠️ Failed to load ${description}: ${error instanceof Error ? error.message : String(error)}`,
          );
          return null;
        }
      };
      ...
      const stacktracePath = path.join(
        projectRoot,
        "node_modules",
        "stacktrace-js",
        "dist",
      ...
      const htmlToImageContent = loadScript(
        htmlToImagePath,
        "html-to-image.js",
      );
      ...
      const workerScripts = [
        ...
        {
          file: "anyon-component-selector-client.js",
          desc: "anyon-component-selector-client.js",
        },
        {
          file: "anyon-screenshot-client.js",
          desc: "anyon-screenshot-client.js",
        },
        {
          file: "anyon-visual-editor-client.js",
          desc: "anyon-visual-editor-client.js",
        },
