...
export const AnyonWrite: React.FC<AnyonWriteProps> = ({
  children,
  node,
  path: pathProp,
              ...
              {isEditing ? (
                <>
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-muted-foreground hover:text-accent-foreground px-2 py-1 rounded cursor-pointer"
                  >
                    <X size={14} />
                    Cancel
                  </button>
