  ...
  const useClearSessionData = () => {
    return useMutation({
      ...
      onSuccess: async () => {
        ...
        showSuccess(t("preview.dataClearedSuccess"));
      },
      onError: (error) => {
        showError(t("preview.dataClearFailed", { message: String(error) }));
      },
    });
  };
