...
(async () => {
  const browser = await electron.launch({
    args: [
      "../../out/anyon-darwin-arm64/anyon.app/Contents/Resources/app.asar/.vite/build/main.js",
      "--enable-logging",
      "--user-data-dir=/tmp/anyon-e2e-tests",
    ],
    executablePath:
      "../../out/anyon-darwin-arm64/anyon.app/Contents/MacOS/anyon",
  });
