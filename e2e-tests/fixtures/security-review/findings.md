...
<anyon-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
<anyon-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<anyon-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<anyon-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<anyon-security-finding title="JWT Secret Using Default Value" level="high">
...
<anyon-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<anyon-security-finding title="Missing Security Headers" level="low">
