---
name: Add Template
about: Request to add a template to Anyon Hub
title: "Add Template: [Template Name]"
labels: "add-template"
assignees: ""
---

If you'd like to add a template to Anyon Hub, follow the [Add Template guide](https://anyon.sh/docs/templates/add-template).
