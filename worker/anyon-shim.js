(function () {
  console.debug("anyon-shim.js loaded via proxy v0.6.0");
      ...
      if (url && typeof url === "string") {
        try {
          ...
          if (
            ...
            console.warn(
              "[anyon-shim] Blocked navigation to unsafe URL protocol:",
              parsedUrl.protocol,
            );
          }
        } catch (e) {
          console.error("[anyon-shim] Invalid navigation URL:", e);
        }
      } else if (url) {
        console.warn("[anyon-shim] Invalid URL type:", typeof url);
      } else {
